const UI = {
  ...
  currentTournament(){
    ...
    if(!State.game.pubTournament || State.game.pubTournament.week !== this.yearWeek()){
      State.game.pubTournament = Tournaments.generatePubTournament(this.yearWeek());
    }
    return State.game.pubTournament;
  },
  ...
  showCalendar(){
    ...
    body += `<p class="small">Hinweis: In allen nicht aufgeführten Wochen kann optional ein Pubturnier gespielt werden. Startgeld: 5 €, Siegerpreisgeld: 100 €.</p>`;
